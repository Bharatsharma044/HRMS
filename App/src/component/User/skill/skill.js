...
const SkillModule = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${BASE_API_URL}skills/getAll`);
        ...
        const DeleteData = async (id) => {
            ...
            if (isConfirmed) {
                try {
                    ...
                    const response = await axios.delete(`${BASE_API_URL}skills/delete?id=${id}`);
                                                ...
                                                <div class="col-md-6 offset-md-3">
                                                    ...
                                                    <form onSubmit={handleSubmit} class="mt-5 border p-4 bg-light shadow">
                                                            <div style={{ textAlign: 'center' }}>
                                                                <h4 style={{ display: 'inline', marginRight: '10px' }} className="mb-5 text-secondary">Add New Skills</h4>
